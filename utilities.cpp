...
std::string Utilities::chunkInstruction(std::string instructions, char* element) {
...
int Utilities::wordCount(char* input) {
    /*
...
void Utilities::toLower(char* input, int inputSize) {
